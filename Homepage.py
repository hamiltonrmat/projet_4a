...
st.page_link("pages/1️⃣_Agribalyse_c'est_quoi.py", label="Agribalyse c'est quoi ?", icon="1️⃣")
st.page_link("pages/page_2.py", label="Introduction à la base de données", icon="2️⃣")
